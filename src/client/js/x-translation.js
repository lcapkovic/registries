...
//FIXME translate into other languages
		...
		$translateProvider.translations('cz', {
			...
			"menu.referee.title": "Rozhodce",
			"menu.coach.title": "Tréner",
			"menu.stadium.title": "Stadion",
			"menu.club.title": "Klub",
			"menu.association.title": "Svaz",
			"menu.person.title": "Osoba",
			"menu.transfer.title": "Změna kl. příslušnosti",
			"menu.season.title": "Soutěžní ročník",
			"menu.age.category.title": "Věková kategorie",
			"menu.roster.title": "Soupisky",
			"menu.competition.title": "Soutěž",
